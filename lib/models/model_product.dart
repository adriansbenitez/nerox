...
class ProductModel {
  ...
  factory ProductModel.fromJson(
    ...
    if (setting?.useViewSocial == true && json['social_network'] is Map) {
      socials = json['social_network'].entries.map<IconModel>((entry) {
        return IconModel(
          title: entry.key,
          value: entry.value,
        );
