        ...
        Container(
          ...
          child: Center(
              child: FxText.bodySmall(
                  Translator.translate('register.success.created'),
                  fontWeight: 600,
                  letterSpacing: 0)),
        ),
        Container(
          ...
          child: Center(
              child: FxText.bodySmall(
                Translator.translate('register.success.description'),
            fontWeight: 500,
            height: 1.15,
        ...
        Container(
          ...
          child: Center(
            child: FxButton(
                ...
                child: FxText.labelLarge(Translator.translate('register.success.login'),
                    fontWeight: 600,
                    letterSpacing: 0.3,
